...
class Pipeline:
    ...
    def main(self):
        ...
        if config['data']['dataset'] == 'resisc':
            ...
            print("Total Eval Data: Positive {} Negative {}".format(len(list(paths.list_images(os.path.joinw(GConst.EVAL_DIR, 'positive')))),len(list(paths.list_images(os.path.join(GConst.EVAL_DIR, 'negative'))))))
